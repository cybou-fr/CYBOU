...
5. **The meaning boundary.** *Partly done 2026-08-23.* `meaning::plan_status` builds a `ResponsePlan`
   ...
   than a topic, bounded by turns, by time, and by erasure. **The meaning boundary is complete.**

   `cybou-meaningd` owns the boundary and is gated: an utterance becomes a
