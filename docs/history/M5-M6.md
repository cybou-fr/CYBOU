...
# Historical Execution — P0 through P6.7

The executable packages that produced the M5 and M6 boundaries, kept verbatim.

They were moved out of [Next Engineering Steps](../NEXT_STEPS.md) because a plan whose first thirty
pages are finished work stops being readable as a plan. Nothing here states current behaviour:
[Current State](../CURRENT_STATE.md) is the implementation authority, and where this document and
the code disagree, this document is simply old.
