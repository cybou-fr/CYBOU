...
> **Historical.** This was the executable plan through the Rust cutover, kept for the reasoning it
> records. Its objective — completing the Rust multi-daemon integration and semantic cutover on
> Debian 13 — was met on 2026-08-20, and the C++/Qt and NixOS trees it refers to were removed the
> same day. [Next Steps](../NEXT_STEPS.md) is the current plan.
