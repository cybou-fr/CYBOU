...
| `cybou-spatial-policy` | a library, not a process — turns what Workspace1 attends to into suggestions a desktop may offer. Reaches nothing and owns no interface; the Living Canvas calls it, and every suggestion waits for a click |
