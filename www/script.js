...
(() => {
  ...
  const translations = {
    en: {
      ...
      status_development: 'Active development',
      status_runtime: 'Implemented runtime',
      status_verified: 'Verified baseline',
    ...
    fr: {
      ...
      status_development: 'Développement actif',
      status_runtime: 'Runtime implémenté',
      status_verified: 'Socle vérifié',
    ...
    ru: {
      ...
      status_development: 'Активная разработка',
      status_runtime: 'Runtime реализован',
      status_verified: 'Проверенный фундамент',
