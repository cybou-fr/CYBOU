...
(() => {
  ...
  const translations = {
    en: {
      ...
      part_donate_text: 'Cybou is an independent open-source project. Your financial support directly funds theme development, ISO build infrastructure, and local AI integration.',
      ...
      faq_a1: 'Cybou is an intelligent personal Linux distribution created by Stanislav Saveliev. Built on NixOS 26.05 and KDE Plasma 6 Wayland, it provides a calm, mathematically reproducible desktop paired with on-device local AI assistance.',
      faq_q2: 'Why is Cybou called a "Smarter Linux"?',
      faq_a2: 'Cybou integrates local SLMs/LLMs directly into the system layer. It offers natural language introspection of NixOS generation changes, build error diagnostics, and local vector context with 100% privacy and zero cloud telemetry.',
      faq_q3: 'Does Cybou require cloud services or send telemetry?',
      faq_a3: 'No. Cybou strictly enforces 100% Zero Telemetry. No accounts, API keys, or external servers are required. All AI models run locally on your GPU/NPU in sandboxed systemd containers.',
      ...
      prog_lead: 'Track the real-time development progress of Cybou v0.1 across NixOS Flakes, Plasma Wayland integration, accessibility contrast, and automated build checks.',
      metric_gate_a: 'Phase 0 & 1 Complete (Plasma Wayland VM boots)',
      metric_tasks: 'Completed Tasks (Phase 0 & Phase 1 verified)',
      metric_contrast: '36 Text Tokens Verified WCAG AA Compliant',
      ...
      rm1_title: 'Visual foundation',
      rm2_title: 'Product foundation',
      rm3_title: 'Read-only intelligence',
      rm4_title: 'A living system',
      ...
      bp_badge: 'Official Technical Blueprint · v0.1 & Architecture',
      bp_title: 'Cybou: The Intelligent & Reproducible Operating System',
      bp_lead: 'A technical blueprint defining the vision, NixOS architecture, KDE Plasma 6 visual system, staged roadmap and acceptance matrix for Cybou.',
      btn_print_pdf: 'Export to PDF / Print',
      btn_explore_landing: 'Explore Web Landing',
      bp_sec1_title: '1. Executive Summary & Core Vision',
      bp_sec1_p1: 'Cybou is a smarter personal Linux distribution engineered around reproducibility and spatial design. It operates under a strict release principle: build a trustworthy body first, and earn every capability added after it.',
      bp_layer1_title: 'Layer 1: Visual & Technical Body (v0.1)',
      bp_layer1_desc: 'Declarative NixOS foundation with atomic generation rollbacks, custom KDE Plasma 6 Wayland desktop theme ("Cybou Horizon"), curated default applications, and zero telemetry.',
      bp_layer2_title: 'Layer 2: Product foundation (v0.2+)',
      bp_layer2_desc: 'Welcome and About applications, a readable generation viewer, better recovery, hardware profiles and guided application installation. Still no autonomous behaviour.',
      bp_sec2_title: '2. Architecture & Technical Stack',
      bp_sec2_p1: 'Cybou combines the immutable, declarative package management of NixOS with modern Wayland desktop infrastructure.',
      bp_stack_title: 'Core System Stack',
      bp_sec3_title: '3. Smarter Linux: what comes after v0.1',
      bp_sec3_p1: 'Cybou earns capability in stages. Nothing below ships in v0.1, and nothing is implemented ahead of the stage that justifies it:',
      bp_ai_point1: '<strong>Understandable updates:</strong> see what changed between two NixOS generations, and why a build failed, without reading raw logs.',
      bp_ai_point2: '<strong>Recoverable by default:</strong> every state is a generation you can return to, so an update is never a one-way door.',
      bp_ai_point3: '<strong>Private by construction:</strong> no telemetry, no account, no runtime downloads — a constraint on every later stage, not a v0.1 detail.',
      bp_ai_point4: '<strong>Proposals, never surprises:</strong> any future system change is a declarative diff presented for approval, applied only by the user.',
      ...
      bp_sec5_title: '5. Security, Licensing & Trademarks',
    ...
    fr: {
      ...
      part_donate_text: 'Cybou est un projet open source indépendant. Votre soutien financier finance directement le développement du thème, l’infrastructure ISO et l’IA locale.',
      ...
      faq_a1: 'Cybou est une distribution Linux personnelle et intelligente créée par Stanislav Saveliev. Basée sur NixOS 26.05 et KDE Plasma 6 Wayland, elle offre un bureau apaisé et reproductible couplé à une assistance IA locale.',
      faq_q2: 'Pourquoi Cybou est-il qualifié de « Linux plus intelligent » ?',
      faq_a2: 'Cybou intègre des modèles IA locaux (SLM/LLM) au niveau système. Il propose une introspection en langage naturel des changements de générations NixOS, l’aide au diagnostic de logs et une mémoire locale 100% privée sans télémétrie cloud.',
      faq_q3: 'Cybou nécessite-t-il des services cloud ou envoie-t-il de la télémétrie ?',
      faq_a3: 'Non. Cybou applique strictly la règle du zéro télémétrie. Aucun compte, clé API ou serveur externe n’est requis. Tous les modèles tournent localement sur votre NPU/GPU dans des conteneurs isolés systemd.',
      ...
      prog_lead: 'Suivez le progrès réel du développement de Cybou v0.1 sur NixOS Flakes, l’intégration Plasma Wayland et les tests d’accessibilité.',
      metric_gate_a: 'Gate A Validée (VM Plasma Wayland fonctionnelle)',
      metric_tasks: 'Tâches terminées (Phases 0 & 1 vérifiées)',
      metric_contrast: '0 Erreur de contraste (36 jetons vérifiés WCAG AA)',
      ...
      rm1_title: 'Fondation visuelle',
      rm2_title: 'Fondation produit',
      rm3_title: 'Intelligence en lecture seule',
      rm4_title: 'Un système vivant',
      ...
      bp_badge: 'Blueprint technique officiel · v0.1 & Architecture',
      bp_title: 'Cybou : Le système d’exploitation intelligent et reproductible',
      bp_lead: 'Un plan technique définissant la vision, l\'architecture NixOS, le système visuel KDE Plasma 6, la feuille de route par étapes et la matrice d\'acceptation de Cybou.',
      btn_print_pdf: 'Exporter en PDF / Imprimer',
      btn_explore_landing: 'Explorer la présentation',
      bp_sec1_title: '1. Résumé exécutif & Vision',
      bp_sec1_p1: 'Cybou est une distribution Linux personnelle plus intelligente, conçue autour de la reproductibilité et du design spatial. Elle suit un principe strict : bâtir d\'abord un corps digne de confiance, puis mériter chaque capacité ajoutée ensuite.',
      bp_layer1_title: 'Couche 1 : Corps visuel & technique (v0.1)',
      bp_layer1_desc: 'Socle déclaratif NixOS avec retours en arrière atomiques, thème KDE Plasma 6 Wayland (« Cybou Horizon ») et zéro télémétrie.',
      bp_layer2_title: 'Couche 2 : fondation produit (v0.2+)',
      bp_layer2_desc: 'Applications Bienvenue et À propos, visualiseur de générations lisible, meilleure récupération, profils matériels et installation guidée. Toujours aucun comportement autonome.',
      bp_sec2_title: '2. Architecture & Stack technique',
      bp_sec2_p1: 'Cybou associe la gestion de paquets déclarative et immuable de NixOS à l’infrastructure moderne Wayland.',
      bp_stack_title: 'Stack système principal',
      bp_sec3_title: '3. Linux plus intelligent : après la v0.1',
      bp_sec3_p1: 'Cybou gagne ses capacités par étapes. Rien de ce qui suit n\'est livré en v0.1, et rien n\'est implémenté avant l\'étape qui le justifie :',
      bp_ai_point1: '<strong>Mises à jour compréhensibles :</strong> voir ce qui a changé entre deux générations NixOS, et pourquoi une compilation a échoué, sans lire les journaux bruts.',
      bp_ai_point2: '<strong>Récupérable par défaut :</strong> chaque état est une génération vers laquelle revenir ; une mise à jour n\'est jamais sans retour.',
      bp_ai_point3: '<strong>Privé par construction :</strong> pas de télémétrie, pas de compte, pas de téléchargement à l\'exécution — une contrainte sur chaque étape ultérieure.',
      bp_ai_point4: '<strong>Des propositions, jamais de surprises :</strong> tout changement système futur est un diff déclaratif soumis à approbation, appliqué uniquement par l\'utilisateur.',
      ...
      bp_sec5_title: '5. Sécurité, Licences & Marques',
    ...
    ru: {
      ...
      part_donate_text: 'Cybou — независимый open-source проект. Ваша финансовая поддержка напрямую финансирует разработку темы, сборку ISO и интеграцию локального ИИ.',
      ...
      faq_a1: 'Cybou — это умный персональный дистрибутив Linux, созданный Станиславом Савельевым. Основанный на NixOS 26.05 и KDE Plasma 6 Wayland, он предлагает воспроизводимую ОС со встроенным локальным ИИ-ассистентом.',
      faq_q2: 'Почему Cybou называют «более умным Linux»?',
      faq_a2: 'Cybou интегрирует локальные нейросети (SLM/LLM) на системный уровень. Это позволяет вслух и на понятном языке анализировать изменения между поколениями NixOS, диагностировать ошибки сборок и вести локальную векторную память без облаков.',
      faq_q3: 'Требуются ли Cybou облачные сервисы или отправка телеметрии?',
      faq_a3: 'Нет. В Cybou строго действует правило 100% Нулевой телеметрии. Не нужны аккаунты или API-ключи. Все ИИ-модели исполняются локально на вашем GPU/NPU в изолированных systemd-контейнерах.',
      ...
      prog_lead: 'Отслеживайте реальный прогресс разработки Cybou v0.1: NixOS Flakes, интеграция Plasma Wayland, контрастность и автоматические сборки.',
      metric_gate_a: 'Gate A пройден (виртуальная машина Plasma Wayland загружается)',
      metric_tasks: 'Выполнено задач (Этапы 0 и 1 верифицированы)',
      metric_contrast: '0 ошибок контрастности (36 токенов текста WCAG AA)',
      ...
      rm1_title: 'Визуальный фундамент',
      rm2_title: 'Продукт и восстановление',
      rm3_title: 'Аналитическая система',
      rm4_title: 'Живая операционная система',
      ...
      bp_badge: 'Официальный технический Blueprint · v0.1 & Архитектура',
      bp_title: 'Cybou: Умная и воспроизводимая операционная система',
      bp_lead: 'Технический план, определяющий видение, архитектуру NixOS, визуальную систему KDE Plasma 6, поэтапный роадмап и матрицу приёмки Cybou.',
      ...
      bp_sec1_p1: 'Cybou — более умный персональный дистрибутив Linux, построенный вокруг воспроизводимости и пространственного дизайна. Он следует строгому принципу: сначала надёжное тело, и лишь затем — заслуженная возможность.',
      bp_layer1_title: 'Слой 1: Визуальный и технический фундамент (v0.1)',
      bp_layer1_desc: 'Декларативная система NixOS с атомарными откатами, оригинальная тема KDE Plasma 6 Wayland ("Cybou Horizon") и нулевая телеметрия.',
      bp_layer2_title: 'Слой 2: продуктовая основа (v0.2+)',
      bp_layer2_desc: 'Приложения «Добро пожаловать» и «О системе», понятный просмотр поколений, улучшенное восстановление, профили оборудования и управляемая установка приложений. По-прежнему без автономного поведения.',
      bp_sec2_title: '2. Архитектура и стек технологий',
      bp_sec2_p1: 'Cybou объединяет неизменяемое декларативное управление пакетами NixOS с современным окружением Wayland.',
      bp_stack_title: 'Основной стек системы',
      bp_sec3_title: '3. Умнее Linux: что будет после v0.1',
      bp_sec3_p1: 'Cybou получает возможности поэтапно. Ничего из перечисленного не входит в v0.1, и ничего не реализуется раньше этапа, который это оправдывает:',
      bp_ai_point1: '<strong>Понятные обновления:</strong> увидеть, что изменилось между поколениями NixOS и почему упала сборка, не читая сырые журналы.',
      bp_ai_point2: '<strong>Восстановимость по умолчанию:</strong> каждое состояние — это поколение, к которому можно вернуться; обновление никогда не билет в один конец.',
      bp_ai_point3: '<strong>Приватность по построению:</strong> ни телеметрии, ни аккаунта, ни загрузок во время работы — ограничение на каждый следующий этап.',
      bp_ai_point4: '<strong>Предложения, а не сюрпризы:</strong> любое будущее изменение системы — декларативный diff на утверждение, применяемый только пользователем.',
      ...
      bp_sec5_title: '5. Безопасность, лицензии и товарные знаки',
