...
pub fn LearningContent(card: CardId) -> impl IntoView {
    ...
    view! {
        <div class="learning-panel" style="display: flex; flex-direction: column; height: 100%; width: 100%; background: var(--bg-card); color: var(--text-main); font-family: system-ui, -apple-system, sans-serif; overflow: hidden;">
            // Header
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 10px 12px; background: var(--bg-sunken); border-bottom: 1px solid var(--line);">
                ...
                <div style="display: flex; align-items: center; gap: 6px;">
                    <button
                        style="background: var(--accent-fill-strong); color: var(--accent-text); border: 1px solid var(--accent-line-strong); border-radius: 4px; padding: 3px 8px; font-size: 11px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 4px;"
            ...
            <div style="display: flex; background: rgba(0,0,0,0.15); border-bottom: 1px solid var(--fill-subtle); padding: 0 12px;">
                <button
                    style=move || if active_tab.get() == "candidates" {
                        ...
                        "background: none; border: none; border-bottom: 2px solid transparent; color: var(--text-second); padding: 8px 12px; font-size: 11px; cursor: pointer;"
                    }
            ...
            <Show when=move || signals.is_proposing.get()>
                <div style="padding: 10px 12px; background: rgba(0,0,0,0.25); border-bottom: 1px solid var(--line); display: flex; flex-direction: column; gap: 8px;">
                    ...
                    <div style="display: flex; justify-content: flex-end; gap: 6px;">
                        <button
                            style="background: var(--fill-subtle); border: none; border-radius: 4px; padding: 4px 10px; font-size: 11px; color: inherit; cursor: pointer;"
                            ...
                            view! {
                                <div style="background: var(--fill-faint); border: 1px solid var(--line); border-radius: 6px; padding: 10px; display: flex; flex-direction: column; gap: 6px;">
                                    <div style="display: flex; align-items: center; justify-content: space-between;">
                                        <div style="display: flex; align-items: center; gap: 6px;">
                                            <span style="background: var(--accent-fill-strong); color: var(--accent-light); border: 1px solid var(--accent-line-strong); border-radius: 4px; padding: 2px 6px; font-size: 10px; font-weight: 700;">
                                                {layer_str}
                                            </span>
                                            <span style="background: var(--fill-subtle); border-radius: 4px; padding: 2px 6px; font-size: 10px; font-family: monospace;">
                                                {cand.scope}
                                            </span>
                                        </div>
                                        <button
                                    ...
                                    <div style="font-size: 12px; font-weight: 500; color: var(--text-pure); line-height: 1.4;">
                                        {cand.generalization}
                                    </div>
                                    <div style="display: flex; gap: 12px; font-size: 10px; color: var(--text-faint);">
                        ...
                        {move || signals.artifacts.get().into_iter().map(|art| {
                            ...
                            view! {
                                <div style="background: var(--fill-faint); border: 1px solid var(--line); border-radius: 6px; padding: 10px; display: flex; flex-direction: column; gap: 6px;">
                                    ...
                                    <div style="font-size: 11px; font-family: monospace; color: var(--text-strong);">
                            ...
                            view! {
                                <div style="background: var(--fill-faint); border: 1px solid var(--line); border-radius: 6px; padding: 10px; display: flex; flex-direction: column; gap: 6px;">
                                    ...
                                    <div style="display: flex; flex-direction: column; gap: 3px; font-size: 11px;">
                                        <div>
                                            <span style="color: var(--text-faint);">"Capabilities: "</span>
                                            {scope.capabilities.join(", ")}
                                        </div>
                                        <div>
                                            <span style="color: var(--text-faint);">"Tool Grants: "</span>
