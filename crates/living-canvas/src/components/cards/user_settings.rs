...
pub fn UserSettingsContent(card: CardId) -> impl IntoView {
    ...
    view! {
        <div class="user-settings-panel" style="display: flex; flex-direction: column; height: 100%; width: 100%; background: var(--bg-card); color: var(--text-main); font-family: system-ui, -apple-system, sans-serif; overflow-y: auto;">
            // Header
