...
pub fn BackupContent(card: CardId) -> impl IntoView {
    ...
    view! {
        <div class="backup-panel" style="display: flex; flex-direction: column; height: 100%; width: 100%; background: var(--bg-card); color: var(--text-main); font-family: system-ui, -apple-system, sans-serif; overflow-y: auto;">
            // Header
                ...
                view! {
                    <div style="padding: 12px; display: flex; flex-direction: column; gap: 14px;">
                        ...
                        <div style="background: var(--fill-faint); border: 1px solid var(--fill-subtle); border-radius: 6px; padding: 12px; display: flex; align-items: center; justify-content: space-between;">
                            <div>
                                <div style="font-weight: 700; font-size: 13px; color: var(--text-bright); margin-bottom: 2px;">{repo.name}</div>
                                ...
                                <div style="font-size: 10px; color: var(--ok); font-family: monospace; margin-top: 2px;">
                        ...
                        <div style="background: var(--fill-faint); border: 1px solid var(--fill-subtle); border-radius: 6px; padding: 10px 12px; display: flex; align-items: center; justify-content: space-between; font-size: 11px;">
                            <div>
                                <div style="font-weight: 600; color: var(--text-bright);">"Automated Snapshot Schedule"</div>
                                ...
                                {archives.into_iter().map(|arch| {
                                    ...
                                    view! {
                                        <div style="background: var(--bg-sunken); border-radius: 4px; padding: 8px 10px; display: flex; align-items: center; justify-content: space-between; font-size: 11px;">
                                            <div>
                                                <div style="font-weight: 600; color: var(--text-bright); margin-bottom: 2px;">{arch.name}</div>
